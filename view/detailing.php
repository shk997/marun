<div>
	<img id="img-podst" src="../resources/images/podst_detail.png" alt="detailing" class="img-responsive">
          ...
          <div class="container-flex">
            ...
            <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <h4 class="step-instr"> Na zewnątrz:</h4>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <h4 class="step-instr"> Wnętrze:</h4>
              </div>
            </div>
            <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <select class="selectpicker" multiple="" data-style="btn-success" style="display: none;">
                  <option>Dekantaminacja lakieru</option>
                </select>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <select class="selectpicker" multiple="" data-style="btn-success" style="display: none;">
                  <option>Pranie tapicerki</option>
                </select>
              </div>
            </div>
          </div>
                ...
                <div class="box">
                  <div class="box-body">
                    <table class="table">
                      ...
                      <tr>                  
                        <td>Alfa</td>
                        <td>Dekantaminacja, czyszczenie tapicerki</td>
                        <td>ble ble</td>
                      </tr>
                    </table>
                  </div>
