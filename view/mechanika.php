<div>
	<img id="img-podst" src="../resources/images/podst_mechan.png" alt="mechanika" class="img-responsive">
          ...
          <div class="container-flex">
            ...
            <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <h4 class="step-instr"> Mechanika ogólna:</h4>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <h4 class="step-instr"> Elektromechanika:</h4>
              </div>
            </div>
            <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
